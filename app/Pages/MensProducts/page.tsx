    ...
    <>
        <div className="Page-section relative">
            <div className="px-[5%] lg:px-[10%] py-40 pb-10">
                <h2 className="text-5xl md:text-7xl lg:text-9xl text-gray-300 font-bold Exo uppercase">Men Clothing</h2>
            </div>
        ...
        <div className="px-[5%] lg:px-[10%] py-20">
            <div className="py-5 mb-10 flex justify-between items-center">
                <div className="Exo text-2xl font-semibold text-gray-700">Showing ({MensProductData.length}) products </div>
